			...
			<table class="table table-bordred">
				<tr>
					...
					<td>
						...
						style="width:120px;" value="<%=dto.getWriter()%>">
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						style="width:350px;" value="<%=dto.getSubject()%>">
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						style="width:250px;" onchange="readURL(this)">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2">
						...
						class="form-control" required="required" placeholder="내용"><%=dto.getContent() %>
						</textarea>
					</td>				
				</tr>
				<tr>
