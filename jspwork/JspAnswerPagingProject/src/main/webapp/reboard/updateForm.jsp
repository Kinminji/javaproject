       ...
       <input type="hidden" name="currentPage" value="<%=currentPage%>">
          ...
          <table class="table table-bordered">
            ...
            <tr>
               ...
               style="width: 320px;" required="required" value="<%=dto.getSubject()%>">
               </td>
            </tr>
            <tr>
              <td colspan="2">
                <textarea style="width: 480px; height: 100px;"
                name="content" class="form-control" value="<%=dto.getContent()%>"></textarea>
              </td>
            </tr>
            <tr>
              <td colspan="2" align="center">
                ...
                style="width: 120px;">
                <input type="button" class="btn btn-success" value="목록이동"
