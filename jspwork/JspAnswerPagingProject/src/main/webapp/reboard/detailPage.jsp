       ...
       <tr>
         <td>
          <div style="float: right;">
	           ...
	           <button type="button" class="btn btn-outline-info"
	           onclick="location.href='updatePassForm.jsp?num=<%=num%>&currentPage=<%=currentPage%>'">수정</button>
	           <button type="button" class="btn btn-outline-info"
	           onclick="location.href='deletePassForm.jsp?num=<%=num%>&currentPage=<%=currentPage%>'">삭제</button>
	           <button type="button" class="btn btn-outline-info"
