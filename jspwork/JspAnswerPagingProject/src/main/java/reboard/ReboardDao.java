...
public class ReboardDao {
	...
	//데이타 추가시 같은그룹중 전달받은 step보다 큰값을 가진 데이타들은 무조건 +1한다
	...
	//판단을 db에 있는 num이 null이면 새글로 null이 아니면 답글로 insert
	public void insertReboard(ReboardDto dto)
	{
		...
		if(num==null) {
			...
			//답글을 의미
			//같은그룹중에서 restep이 전달받은값보다 큰경우 무저건1증가
	...
	//페이징_1.범위에 따른리스트,2.총갯수
	//1.범위에 따른리스트
	public List<ReboardDto> getPagingList(int startnum,int perpage)
	{
