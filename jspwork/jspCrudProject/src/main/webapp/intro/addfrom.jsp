			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						...
						style="width: 200px" value="2000-01-01">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<label><input type="radio" name="hometown" value="성동구" checked="checked">&nbsp;성동구&nbsp;</label>
						<label><input type="radio" name="hometown" value="광진구">&nbsp;광진구&nbsp;</label>
						<label><input type="radio" name="hometown" value="송파구">&nbsp;송파구&nbsp;</label>
						<label><input type="radio" name="hometown" value="동대문구">&nbsp;동대문구&nbsp;</label>
						<label><input type="radio" name="hometown" value="기타">&nbsp;기타&nbsp;</label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						name="free" required="required" placeholder="자신의 성향 혹은 하고싶은 말을 자유롭게 작성해주세요."
						class="form-control">
						</textarea>
					</td>
				</tr>
